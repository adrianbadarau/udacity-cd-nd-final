package com.adrianbadarau.klist.items.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.adrianbadarau.klist.items.repository..*)" +
            " || within(com.adrianbadarau.klist.items.service..*)" +
            " || within(com.adrianbadarau.klist.items.web.rest..*)"
    )
