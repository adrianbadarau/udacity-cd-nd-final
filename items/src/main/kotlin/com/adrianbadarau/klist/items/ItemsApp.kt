...
import com.adrianbadarau.klist.items.config.ApplicationProperties
...
class ItemsApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ItemsApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
