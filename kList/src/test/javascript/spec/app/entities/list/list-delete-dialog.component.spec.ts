...
import { ListDeleteDialogComponent } from 'app/entities/list/list-delete-dialog.component';
import { ListService } from 'app/entities/list/list.service';

describe('Component Tests', () => {
  describe('List Management Delete Component', () => {
    let comp: ListDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ListDeleteDialogComponent, '')
        .compileComponents();
