...
import com.adrianbadarau.klist.front_end.config.ApplicationProperties
...
@EnableZuulProxy
class KListApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KListApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KListApp::class.java)
