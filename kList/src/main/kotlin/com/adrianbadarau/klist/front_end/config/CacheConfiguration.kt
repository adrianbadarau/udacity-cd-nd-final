...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.adrianbadarau.klist.front_end.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.adrianbadarau.klist.front_end.repository.UserRepository.USERS_BY_EMAIL_CACHE)
