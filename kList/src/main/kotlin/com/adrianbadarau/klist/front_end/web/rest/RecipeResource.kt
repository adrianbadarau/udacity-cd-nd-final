...
import com.adrianbadarau.klist.front_end.repository.RecipeRepository
...
private const val ENTITY_NAME = "recipe"
/**
 * REST controller for managing [com.adrianbadarau.klist.front_end.domain.Recipe].
 */
@RestController
@RequestMapping("/api")
