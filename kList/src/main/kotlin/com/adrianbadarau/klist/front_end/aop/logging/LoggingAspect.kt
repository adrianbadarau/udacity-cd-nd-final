package com.adrianbadarau.klist.front_end.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.adrianbadarau.klist.front_end.repository..*)" +
            " || within(com.adrianbadarau.klist.front_end.service..*)" +
            " || within(com.adrianbadarau.klist.front_end.web.rest..*)"
    )
