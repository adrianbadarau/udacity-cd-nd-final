...
@Configuration
@EnableReactiveMongoRepositories("com.adrianbadarau.klist.notifications.repository")
...
class DatabaseConfiguration {
    ...
    fun mongobee(mongoClient: MongoClient, mongoTemplate: MongoTemplate, mongoProperties: MongoProperties): Mongobee {
        ...
        return Mongobee(mongoClient).apply {
            ...
            setChangeLogsScanPackage("com.adrianbadarau.klist.notifications.config.dbmigrations")
            isEnabled = true
        }
    }
}
