package com.adrianbadarau.klist.notifications.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.adrianbadarau.klist.notifications.repository..*)" +
            " || within(com.adrianbadarau.klist.notifications.service..*)" +
            " || within(com.adrianbadarau.klist.notifications.web.rest..*)"
    )
